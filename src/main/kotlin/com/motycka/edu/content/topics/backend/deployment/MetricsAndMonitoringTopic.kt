...
object MonitoringIntroSlide : Slide(
    ...
    content = {
        twoColumns(
            ...
            right = {
                p {
                    h4 { +"Observability Three Pillars" }
                    ol {
...
object MetricsTypesSlide : Slide(
    ...
    content = {
        ...
        p {
            h4 { +"Custom Metrics in Spring Boot" }
            kotlinPlayground(
                code = """
                @Service
                class OrderService(
...
object MonitoringToolsSlide : Slide(
    ...
    content = {
        twoColumns(
            left = {
                p {
                    h4 { +"Popular Monitoring Tools" }
                    ul {
                        li {
                            strong { +"Metrics Collection & Storage" }
                            ul {
                                li {
                                    strong { +"Prometheus" }
