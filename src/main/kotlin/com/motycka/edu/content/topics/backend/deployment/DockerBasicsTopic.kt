...
object DockerConceptsSlide : Slide(
    ...
    content = {
        ...
        p { highlight("Containers vs Virtual Machines:") }
        ul {
...
object DockerCommandsSlide : Slide(
    ...
    content = {
        ...
        p { highlight("Container Commands:") }
        pre {
            +"""
            # Run a container
