...
object TestabilityTopic : Topic(
    title = "Design for Testability",
    slides = listOf(
        TestabilityIntroSlide
    )
)

object TestabilityIntroSlide : Slide(
    ...
    content = {
        ul {
            li {
                strong { highlight("Single Responsibility Principle (SRP)") }
                br()
            ...
            li {
                strong { highlight("Open/Closed Principle (OCP)") }
                br()
            ...
            li {
                strong { highlight("Liskov Substitution Principle (LSP)") }
                br()
            ...
            li {
                strong { highlight("Interface Segregation Principle (ISP)") }
                br()
            ...
            li {
                strong { highlight("Dependency Inversion Principle (DIP)") }
                br()
            ...
            li {
                strong { highlight("Constructor Injection") }
                br()
            ...
            li {
                strong { highlight("Fewer Dependencies = Simpler Tests") }
                br()
