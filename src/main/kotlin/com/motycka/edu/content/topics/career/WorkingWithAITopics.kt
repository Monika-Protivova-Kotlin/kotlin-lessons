...
object AIAsLearningToolSlide : Slide(
    ...
    content = {
        p {
            strong { +"How to use AI for learning:" }
        }
        ul {
            li {
...
object AIAsProductivityToolSlide : Slide(
    ...
    content = {
        p {
            strong { +"Effective uses for productivity:" }
        }
        ul {
            li {
        ...
        p {
            highlight("The productivity pattern:")
        }
        ol {
        ...
        p {
            strong { +"You're still in control." }
    ...
    content = {
        twoColumns(
            left = {
                ...
                p { strong { +"How to use:" } }
                p { +"Quick review → Test → Accept" }
            },
            right = {
                p { strong { +"Needs careful verification:" } }
                ul {
                ...
                p { strong { +"How to use:" } }
                p { +"Thorough review → Understand → Test extensively → Verify → Accept" }
            }
        )
        p {
            highlight("Red flags - Don't trust AI when:")
        }
        ul {
...
object AIAsPairProgrammerSlide : Slide(
    ...
    content = {
        p {
            strong { +"The pair programming mindset:" }
        }
        p {
...
object ValidatingAICodeTopic : Topic(
...
object CodeReviewPrinciplesSlide : Slide(
    ...
    content = {
        ...
        p {
            highlight("Remember: You're responsible for the code, not the AI.")
        }
    }
)
...
object TestingAICodeSlide : Slide(
    ...
    content = {
        p {
            strong { +"Why test AI code more thoroughly?" }
        }
        ul {
